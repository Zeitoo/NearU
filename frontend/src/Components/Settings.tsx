...
export default function Settings() {
	return (
		<div className="settings text-sm pb-20">
			...
			<div className="profile flex justify-center mt-10">
				<div className="relative ">
					...
					/>
					<div className="flex bottom-0 right-0 bg-indigo-300 absolute z-10 w-9 rounded-[100px] justify-center items-center aspect-square">
						<svg
			...
			<div>
				<div className="flex justify-center my-5">
					<button className="p-5 py-2 bg-indigo-100 font-semibold text-indigo-500 hover:bg-indigo-200 hover:text-indigo-600 rounded-lg">
						Editar perfil
					</button>
				</div>
				...
				<div className="p-5">
					...
					<div>
						<div className="flex w-full justify-between mt-2 p-3 py-4 rounded-lg bg-indigo-200">
							...
							<div className="h-full text-[12px] ml-2 w-full flex-1 flex justify-center flex-col">
								<p className="font-semibold">Modo Fantasma</p>
					...
					<div className="border w-full overflow-hidden border-gray-300 rounded-lg ">
						<div className="w-full border-b border-b-gray-400 transition-all hover:bg-gray-200 flex p-2">
							<div className="p-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
						...
						<div className="w-full hover:bg-gray-200 flex p-2">
							<div className="p-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
					...
					<div className="border overflow-hidden w-full border-gray-300 rounded-lg ">
						...
						<NavLink
							to="assitencia"
							className="w-full transition-all hover:bg-gray-200 flex p-2">
							<div className="p-2">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
					...
					<div className="border bg-red-50 mt-9 overflow-hidden w-full border-gray-300 rounded-lg ">
						<NavLink
							to="signout"
							className="w-full border-b transition-all  hover:bg-gray-200 border-b-gray-400 flex items-center justify-center gap-2 p-4">
							<div className="">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									fill="none"
						...
						<NavLink
							to="deleteaccount"
							className="w-full transition-all hover:bg-gray-200 p-4">
