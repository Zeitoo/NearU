					...
					{editMode ? (
						...
						<>
							...
							<div
								...
								className="flex bottom-0 right-0 bg-indigo-300 absolute z-10 w-9 rounded-[100px] justify-center items-center aspect-square">
								<svg
					...
					<div className="appear p-5">
						...
						<div>
							<div
								...
								className="flex w-full justify-between mt-2 p-3 py-4 rounded-lg bg-indigo-200">
